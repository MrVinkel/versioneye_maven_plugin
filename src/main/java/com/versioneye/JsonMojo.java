...
public class JsonMojo extends AbstractSuperMojo {
    ...
    public void doExecute() throws Exception {
        ...
        ByteArrayOutputStream dependenciesAsJsonStream = dependencyToJsonConverter.getDependenciesAsJsonStream(nameStrategy, transitiveDependencies, excludeScopes);
